...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  try {
    ...
    const system = 'You are a DnD GM assistant that writes scene details consistent with previous context. All text output must be in English. Use clear, natural language suitable for tabletop Game Masters. Do not use Turkish words or local idioms. MUST include skillChallenges field with at least 1 skill challenge.'
...
SKILL CHECK IMPROVEMENTS:
- Include dnd_skill field for each skill check (examples: "Insight", "Investigation", "Arcana", "Perception", "Athletics", "Stealth").
- skill field can be English description, dnd_skill field should be standard D&D skill name.
- Example: skill: "Reading Body Language", dnd_skill: "Insight"

EXAMPLE skill check:
{
  "type": "skill",
  "ability": "Wisdom",
  "skill": "Reading Body Language",
  "dnd_skill": "Insight",
  "dc_suggested_range": [12, 16],
  "dc": 14,
  "check_label": "Reading Body Language",
  "when": "When whispers are heard",
  "on_success": "The character understands that the whispers are a warning.",
  "on_fail": "The character cannot find the source of the whispers.",
  "advantage_hints": ["Character's previous experiences", "Silence in the environment"]
}
