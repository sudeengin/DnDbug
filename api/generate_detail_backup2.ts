...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  try {
    ...
    const system = 'You are a DnD GM assistant that writes scene details consistent with previous context.'
...
- "skillChallenges": (Yeni alan) Oyuncuların belirli anlarda zar atabileceği fırsatları tanımla.
  Her bir giriş aşağıdaki yapıyı kullanmalı:
  {
    "skill": "Skill name (examples: Insight, Investigation, Arcana)",
    "dc": "Difficulty class (examples: 13, 15, 17)",
    "trigger": "When do players trigger this check?",
    "success": "What do they notice or gain when they succeed?",
    "failure": "What do they misunderstand or lose if they fail?",
    "consequence": "What is the short-term effect of this failure?"
  }

Kurallar:
- Each scene should have at least 1 skill challenge (maximum 3).
- Skills should be appropriate to the scene's theme (example: Investigation in mysterious room, Arcana in magic).
- Success provides information or advantage; failure causes misdirection or minor risk.
- Skill results should be brief enough not to disrupt the scene's atmosphere.
