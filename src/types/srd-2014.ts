...
export const SRD_BACKGROUNDS: Background[] = [
  ...
  },
  {
    ...
    feature: {
      name: 'Ship\'s Passage',
      description: 'When you need to, you can secure free passage on a sailing ship for yourself and your adventuring companions. You might sail on the ship you served on, or another ship you have good relationships with (perhaps one captained by a former crewmate). Because you\'re calling in a favor, you can\'t be certain of a schedule or route that will meet your every need. Your DM will determine how long it takes to get where you need to go. In return for your free passage, you and your companions are expected to assist the crew during the voyage.'
    },
    personalityTraits: [
  ...
  },
  {
    ...
    ideals: [
      ...
      'Might. In life as in war, the strongest force wins. (Evil)',
    ...
    flaws: [
      ...
      'I obey the law, even if the law is misguided.',
  ...
  },
  {
    ...
    ideals: [
      ...
      'Greed. I will do whatever it takes to become wealthy. (Evil)',
      'People. I\'m loyal to my friends, not to any ideals. Everyone else can take care of themselves. (Neutral)',
  ...
  },
  {
    ...
    personalityTraits: [
      ...
      'I don\'t pay much attention to the people around me.',
      'I connect everything that happens to me to a grand, cosmic plan.'
    ],
    ideals: [
  ...
  },
  {
    ...
    bonds: [
      ...
      'My escape from destitution was a community effort, and I work to make sure others have the same opportunity.',
      'I have a family, but I have no idea where they are. One day, I hope to see them again.'
    ],
    flaws: [
